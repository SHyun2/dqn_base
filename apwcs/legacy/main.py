...
import apwcs.dqn_model as model
...
def replay_train(mainDQN: model.DQN, targetDQN: model.DQN, train_batch: list) -> float:
...
def bot_play(mainDQN: model.DQN, env: gym.Env) -> None:
