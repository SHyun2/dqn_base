...
def bot_play(mainDQN: dqn.DQN, env: mec_env.MecEnv) -> None:
...
def main():
    ...
    with tf.Session() as sess:
        ...
        for episode in range(MAX_EPISODES):
            ...
            game_list.append(step_count)

            if len(game_list) == 200:
                print("Loss: {}".format(loss))
                avg_reward = np.mean(game_list)
                print("Episode: {}  avg steps: {}".format(episode, avg_reward))
                game_list = []
